        ...
        <div className="text-center mb-12">
          ...
          <div className="relative max-w-2xl mx-auto mb-8">
            ...
            <input
              ...
              className="w-full pl-14 pr-6 py-5 bg-white rounded-3xl shadow-xl shadow-emerald-900/5 border-none focus:ring-2 focus:ring-emerald-500 outline-none text-lg transition-all"
              value={query}
